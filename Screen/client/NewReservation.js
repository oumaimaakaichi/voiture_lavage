        ...
        <SafeAreaView style={{ backgroundColor: 'white' }}>
            <ScrollView >
                ...
                <Image
                    ...
                    ></Image>
                    <Text style={{ color: '#4A919E', fontWeight: 'bold' , fontSize:15 , marginTop:20 , marginStart:8 , marginBottom:20}}>
                        Information de la station
                    </Text>
                    <Text style={{marginBottom:10}}>  Type de lavage: {station?.type_lavage}</Text>
                    <Text style={{marginBottom:10}}>  Ville  :{station?.ville}</Text>
                    <Text style={{marginBottom:10}}>  Adresse   : {station?.adresse}</Text>
